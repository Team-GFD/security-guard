...
execute if score @s[tag=!shp_handled] menu_id matches 9 run function menu:events/action/aicount/up_arrow
execute if score @s[tag=!shp_handled] menu_id matches 10 run function menu:events/action/aicount/down_arrow
