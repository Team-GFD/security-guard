...
execute if score #starting game matches 0 if score @s[tag=!shp_handled] menu_id matches 4 run function menu:events/shift_action/door_switch

execute if score #starting game matches 0 if score @s[tag=!shp_handled] menu_id matches 6 run function menu:events/shift_action/artifact/up_arrow
execute if score #starting game matches 0 if score @s[tag=!shp_handled] menu_id matches 7 run function menu:events/shift_action/artifact/down_arrow

execute if score #starting game matches 0 if score @s[tag=!shp_handled] menu_id matches 9 run function menu:events/shift_action/aicount/up_arrow
execute if score #starting game matches 0 if score @s[tag=!shp_handled] menu_id matches 10 run function menu:events/shift_action/aicount/down_arrow
