...
execute if score @s[tag=shp_hover,tag=shp_menu_doors] menu_viewers matches 1.. unless score @s menu_viewers = @s old_menu_viewers run function menu:events/hover
execute if score @s[tag=!shp_hover] menu_viewers matches 1.. run function menu:events/hover

execute if score @s[tag=!shp_hover,tag=shp_menu_doors] menu_viewers matches 0 unless score @s menu_viewers = @s old_menu_viewers run function menu:events/unhover
