...
execute positioned -9.5 2.0 0.0 run function menu:items/create/aicount/title
execute positioned -9.5 2.0 0.0 run function menu:items/create/aicount/up_arrow
execute positioned -9.5 2.0 0.0 run function menu:items/create/aicount/down_arrow
execute positioned -9.5 2.0 0.0 run function menu:items/create/aicount/left_number
execute positioned -9.5 2.0 0.0 run function menu:items/create/aicount/right_number
