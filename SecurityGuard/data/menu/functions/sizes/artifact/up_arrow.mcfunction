...
scoreboard players add boxAZ rayData 208
scoreboard players operation boxBZ rayData = #z rayData
scoreboard players remove boxBZ rayData 208

scoreboard players operation boxAY rayData = #y rayData
scoreboard players add boxAY rayData 648
scoreboard players operation boxBY rayData = #y rayData
scoreboard players add boxBY rayData 883
