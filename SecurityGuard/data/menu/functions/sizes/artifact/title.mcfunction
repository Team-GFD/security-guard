...
scoreboard players add boxAZ rayData 1350
scoreboard players operation boxBZ rayData = #z rayData
scoreboard players remove boxBZ rayData 1350

scoreboard players operation boxAY rayData = #y rayData
scoreboard players add boxAY rayData 1062
scoreboard players operation boxBY rayData = #y rayData
scoreboard players add boxBY rayData 1875
