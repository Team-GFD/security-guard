...
scoreboard players add boxAX rayData 1437
scoreboard players operation boxBX rayData = #x rayData
scoreboard players remove boxBX rayData 1437

scoreboard players operation boxAY rayData = #y rayData
scoreboard players add boxAY rayData 4937
scoreboard players operation boxBY rayData = #y rayData
scoreboard players add boxBY rayData 63
