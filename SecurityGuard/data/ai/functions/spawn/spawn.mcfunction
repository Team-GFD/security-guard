...
execute at @e[tag=thief_spawn,limit=1] positioned ~ ~-50 ~ run summon minecraft:zombified_piglin ~ ~ ~ {Tags:["AI","AI_pathfind","AI_spawning"],Team:"AI",CustomName:"\"AI\"",Silent:1b,PersistenceRequired:1b,Attributes:[{Name:"generic.movement_speed",Base:0.3f},{Name:"generic.follow_range",Base:1000.0d}],DeathLootTable:"minecraft:empty"}
...
execute unless score number AI matches ..0 run schedule function ai:spawn/spawn 1s
