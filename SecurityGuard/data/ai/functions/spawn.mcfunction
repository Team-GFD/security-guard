...
execute at @e[tag=thief_spawn,tag=AI_spawn,limit=1] positioned ~ ~-50 ~ run summon minecraft:enderman ~ ~ ~ {Tags:["AI","AI_pathfind","AI_spawning"],Team:"AI",CustomName:"\"AI\"",Silent:1b,PersistenceRequired:1b,Attributes:[{Name:"generic.movementSpeed",Base:0.15f},{Name:"generic.followRange",Base:1000.0d}]}
