...
execute if score @s[tag=shp_right_door] door_tick matches 20 at @s at @e[type=minecraft:armor_stand,sort=nearest,limit=1,tag=exit_door] run fill ^-1 ^ ^1 ^-2 ^2 ^1 air