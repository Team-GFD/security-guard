...
execute if score end_cooldown game matches 0 run execute as @e[type=minecraft:area_effect_cloud,tag=lobby,limit=1] at @s run particle minecraft:cloud ~ ~1 ~ 0.25 0.5 0.25 0.01 100 normal
