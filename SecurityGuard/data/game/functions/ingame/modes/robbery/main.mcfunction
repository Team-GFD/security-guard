...
execute as @a at @s at @s[tag=lower,y=113,dy=1000,team=!9Spectator] run function game:ingame/map/up
execute as @a at @s at @s[tag=upper,y=112,dy=-1000,team=!9Spectator] run function game:ingame/map/down
