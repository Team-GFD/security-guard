...
replaceitem entity @s hotbar.8 minecraft:carrot_on_a_stick{Unbreakable:1b,display:{Name:'{"text":"Enter Camera","italic":false}',Lore:['{"text":"Click to enter camera mode.","color":"gray","italic":false}']},tag:["killme"],CustomModelData:1} 1
