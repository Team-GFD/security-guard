...
execute as @a[team=2Thief] run function game:ingame/modes/free_for_all/setup_thief
execute as @a[team=1Guard] run function game:ingame/modes/free_for_all/setup_guard
...
team modify 2Thief friendlyFire true