...
execute if score stolen game >= required game run tellraw @a ["",{"text":"                                                         ","bold":true,"strikethrough":true,"color":"aqua"},{"text":"\n"},{"text":"               Security Guard II","bold":true,"color":"blue"},{"text":"\n"},{"text":"\n"},{"text":"                Winner: ","bold":true,"color":"white"},{"text":"THIEVES","color":"red"},{"text":"\n"},{"text":"\n"},{"text":"              Top Guard: ","color":"white"},{"selector":"@a[tag=mvp_kills,sort=random,limit=1]","color":"gray"},{"text":" ("},{"score":{"name": "#max_kills", "objective": "kills"}},{"text":" captures)\n"},{"text":"             Top Thief: ","color":"white"},{"selector":"@e[tag=mvp_stolen,sort=random,limit=1]","color":"gray"},{"text":" ("},{"score":{"name": "#max_stolen", "objective": "stolen"}},{"text":" artifacts)\n"},{"text":"                                                         ","bold":true,"strikethrough":true,"color":"aqua"}]
execute unless score stolen game >= required game run tellraw @a ["",{"text":"                                                         ","bold":true,"strikethrough":true,"color":"aqua"},{"text":"\n"},{"text":"               Security Guard II","bold":true,"color":"blue"},{"text":"\n"},{"text":"\n"},{"text":"                Winner: ","bold":true,"color":"white"},{"text":"GUARDS","color":"dark_aqua"},{"text":"\n"},{"text":"\n"},{"text":"              Top Guard: ","color":"white"},{"selector":"@e[tag=mvp_kills,sort=random,limit=1]","color":"gray"},{"text":" ("},{"score":{"name": "#max_kills", "objective": "kills"}},{"text":" captures)\n"},{"text":"             Top Thief: ","color":"white"},{"selector":"@a[tag=mvp_stolen,sort=random,limit=1]","color":"gray"},{"text":" ("},{"score":{"name": "#max_stolen", "objective": "stolen"}},{"text":" artifacts)\n"},{"text":"                                                         ","bold":true,"strikethrough":true,"color":"aqua"}]
