...
tellraw @a [{"text":"           Top Thief: ","color":"#d63c3c","bold":true},{"selector":"@a[tag=mvp_stolen,limit=1]","color":"aqua","bold":false},{"text":" (","color":"#afafaf","bold":false},{"score":{"name":"#max_stolen","objective":"kills"},"color":"#afafaf","bold":false},{"text":" Artifacts)\n","color":"#afafaf","bold":false}]
