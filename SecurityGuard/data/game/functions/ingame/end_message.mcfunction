...
execute if entity @e[tag=mvp_stolen] run tellraw @a [{"text":"           Top Thief: ","color":"#d63c3c","bold":true},{"selector":"@e[tag=mvp_stolen,limit=1]","color":"aqua","bold":false},{"text":" (","color":"#afafaf","bold":false},{"score":{"name":"#max_stolen","objective":"kills"},"color":"#afafaf","bold":false},{"text":" Artifacts)\n","color":"#afafaf","bold":false}]
execute unless entity @e[tag=mvp_stolen] run tellraw @a [{"text":"                   Top Thief: ","color":"#d63c3c","bold":true},{"text":"None\n","color":"#afafaf","bold":false}]

tellraw @a [{"text":"               Most Stolen: ","color":"#dfdfdf","bold":true},{"selector":"@a[tag=most_stolen,limit=1]","color":"red","bold":false},{"text":" (","color":"#afafaf","bold":false},{"score":{"name":"#most_stolen","objective":"stolen"},"color":"#afafaf","bold":false},{"text":" )","color":"#afafaf","bold":false}]
