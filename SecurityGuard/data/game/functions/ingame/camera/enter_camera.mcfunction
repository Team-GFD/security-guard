...
execute if score state game matches 1 run title @s[team=Guard] subtitle [{"text":"Sneak to Leave Camera Mode.","color":"dark_aqua","bold":true}]
execute if score state game matches 1 run title @s[team=!Guard] subtitle [{"text":"Scroll to Change Camera View.","color":"dark_aqua","bold":true}]
