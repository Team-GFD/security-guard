...
execute as @s[tag=!camera_mode] unless entity @s[team=!4Escaped,team=!3Dead] if score #inv_control game matches 0 run replaceitem entity @s hotbar.0 minecraft:carrot_on_a_stick{display:{Name:'{"text":"Enter Camera","italic":false}',Lore:['{"text":"Click to enter camera mode.","color":"gray","italic":false}']},tag:["killme"],CustomModelData:1} 1
